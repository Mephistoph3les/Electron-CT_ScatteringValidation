...
if __name__ == '__main__':
    ...
    cores = '80'
    thicknesses_alu = ['0um', '70um', '200um', '270um', '400um', '600um', '1000um', '1400um', '2000um', '3000um', '4000um', '6000um']
    material = 'alu'
    events = '1000'
    ...
    time_file = 'timing_data/computing_time_%s_all_%s_155MeV.csv' % (material, events)
