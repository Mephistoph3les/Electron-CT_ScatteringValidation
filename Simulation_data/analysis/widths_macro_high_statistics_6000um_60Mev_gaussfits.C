...
void widths_macro_high_statistics_6000um_60Mev_gaussfits() {
    string events = "100000";
    string material = "aluminum";
    string thick = "6000um";

    string data_Opt1_6000um = "../alu_6000um_100000_events_60MeV/EM_Opt1/Corryoutput/histograms.root";
    string data_Opt3_6000um = "../alu_6000um_100000_events_60MeV/EM_Opt3/Corryoutput/histograms.root";
    string data_Opt4_6000um = "../alu_6000um_100000_events_60MeV/EM_Opt4/Corryoutput/histograms.root";
    ...
    hx2_6000um->SetTitle("Aluminum 6000um model comparison 60MeV");
    hx2_6000um->GetXaxis()->SetTitle("Width X [px]");
    hx2_6000um->GetYaxis()->SetTitle("# frames");
    hx2_6000um->GetXaxis()->SetRangeUser(0,5);
    hx3_6000um->GetXaxis()->SetRangeUser(0,5);
    hx6_6000um->GetXaxis()->SetRangeUser(0,5);
    ...
    c1->SaveAs("PDFs/Gauss_Widths_100000_events_6000um_alu_60MeV.pdf");
}
