...
if __name__ == '__main__':
    ...
    os.system('source ../../allpix-squared/etc/scripts/setup_lxplus.sh')
    ...
    #thicknesses_alu = ['70um', '200um', '270um', '400um', '600um']
    thicknesses_alu = ['1000um','1400um','2000um','3000um', '4000um','6000um']
    #thicknesses_alu = ['3000um', '4000um', '6000um']
    #thicknesses_alu = ['1000um']
    material = 'alu'
    events = '10000'
    EM_modules_list = ["EM_Opt0", "EM_Opt3", "EM_Opt4"]
    EM_modules_mark = ["", "_EMY", "_EMZ"]
    differences = []
    thick_list = []
    EM_model_list = []
    material_list = []
    ...
    time_file = 'timing_data/computing_time_upper_half_alu_run_30_cores.csv'
